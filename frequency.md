...
82) 706. Design HashMap
	...
	Сколько раз решал: 1
	Время: 18:15
	Комментарий: Просто реализация мапы в супер простом варианте.
	Tag: Slice
...
92) 207. Course Schedule
	...
	Сколько раз решал: 1
	Время: 24:40
	Комментарий: Решал через рекурсивный DFS. Но также создал массив смежности, а именно из какого курса переходим
